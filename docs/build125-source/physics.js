import {observeTravel} from './motion125/travel.mjs';
import {observeRideDynamics} from './motion125/dynamics.mjs';
...
export const COAST_FEEL=Object.freeze({roadResistance:.108,dirtResistance:1.35,airDrag:.007,restSpeed:.044704,restSeconds:1});
export class Ride {
 ...
 // End a spent coast below 0.1 mph, regardless of car speed or slope.
