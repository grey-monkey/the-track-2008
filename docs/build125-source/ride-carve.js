...
export function rideCarve(h,lean,crouch,time,dt){
 ...
 h.motionLoad=(h.rideResponse?.load??0)*air*(1-.6*h.crouch);h.motionBrake=(h.rideResponse?.brake??0)*air*(1-.6*h.crouch);h.motionFlight=(h.rideResponse?.flight??0)*(1-.4*h.crouch);
